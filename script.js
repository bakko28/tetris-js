...
import { convertPositionToIndex, PLAYFIELD_COLUMNS, PLAYFIELD_ROWS } from "./utilites.js";
...
function gameOver() {
    ...
    hammer.off('panstart panleft panright pandown tap')
    gameOverAnimation();
}
...
function gameOverAnimation() {
    ...
    document.querySelector('.refresh-button').style.display = 'flex'
}
